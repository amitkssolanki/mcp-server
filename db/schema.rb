...
ActiveRecord::Schema[8.1].define(version: 2026_08_07_145632) do
  ...
  create_table "olist_line_item_details", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.decimal "freight_value", precision: 10, scale: 2, default: "0.0", null: false
    t.bigint "olist_seller_id", null: false
    t.datetime "shipping_limit_at"
    t.bigint "spree_line_item_id", null: false
    t.datetime "updated_at", null: false
    t.index ["olist_seller_id"], name: "index_olist_line_item_details_on_olist_seller_id"
    t.index ["spree_line_item_id"], name: "index_olist_line_item_details_on_spree_line_item_id", unique: true
  end

  create_table "olist_order_details", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["days_late"], name: "index_olist_order_details_on_days_late"
    t.index ["olist_customer_unique_id"], name: "index_olist_order_details_on_olist_customer_unique_id"
    t.index ["olist_order_id"], name: "index_olist_order_details_on_olist_order_id", unique: true
    t.index ["olist_status"], name: "index_olist_order_details_on_olist_status"
    t.index ["purchased_at"], name: "index_olist_order_details_on_purchased_at"
    t.index ["spree_order_id"], name: "index_olist_order_details_on_spree_order_id", unique: true
  end

  create_table "olist_payment_details", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.integer "installments", default: 0, null: false
    t.string "payment_type", null: false
    t.bigint "spree_payment_id", null: false
    t.datetime "updated_at", null: false
    t.index ["payment_type"], name: "index_olist_payment_details_on_payment_type"
    t.index ["spree_payment_id"], name: "index_olist_payment_details_on_spree_payment_id", unique: true
  end

  create_table "olist_reviews", force: :cascade do |t|
    ...
    t.string "title"
    t.datetime "updated_at", null: false
    t.index ["olist_review_id"], name: "index_olist_reviews_on_olist_review_id"
    t.index ["score"], name: "index_olist_reviews_on_score"
    t.index ["spree_order_id"], name: "index_olist_reviews_on_spree_order_id"
  end

  create_table "olist_sellers", force: :cascade do |t|
    t.string "city"
    t.datetime "created_at", null: false
    ...
    t.index ["olist_seller_id"], name: "index_olist_sellers_on_olist_seller_id", unique: true
    t.index ["state"], name: "index_olist_sellers_on_state"
  end
  ...
  add_foreign_key "olist_line_item_details", "olist_sellers"
  add_foreign_key "olist_line_item_details", "spree_line_items"
  add_foreign_key "olist_order_details", "spree_orders"
  add_foreign_key "olist_payment_details", "spree_payments"
  add_foreign_key "olist_reviews", "spree_orders"
